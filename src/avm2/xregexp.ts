module Shumway.AVM2 {
   ...
   */
      function setNatives(on) {
          RegExp.prototype.exec = (<any>(on ? fixed : nativ)).exec;
          RegExp.prototype.test = (<any>(on ? fixed : nativ)).test;
          String.prototype.match = (<any>(on ? fixed : nativ)).match;
          String.prototype.replace = (<any>(on ? fixed : nativ)).replace;
          String.prototype.split = (<any>(on ? fixed : nativ)).split;
   ...
   */
      self.exec = function(str, regex, pos, sticky) {
          ...
          match = (<any>fixed).exec.call(r2, str);
   ...
   */
      self.replace = function(str, search, replacement, scope) {
          ...
          result = (<any>fixed).replace.call(toObject(str), s2, replacement);
   ...
   */
      self.split = function(str, separator, limit) {
          return (<any>fixed).split.call(toObject(str), separator, limit);
      };
   ...
   * @returns {Boolean} Whether the regex matched the provided value.
   */
  (<any>fixed).test = function(str) {
          // Do this the easy way :-)
          return !!(<any>fixed).exec.call(this, str);
      };
   ...
   */
  (<any>fixed).match = function(regex) {
          var result;
          ...
          return (<any>fixed).exec.call(regex, toObject(this));
      };
   ...
   * @returns {String} New string with one or all matches replaced.
   */
  (<any>fixed).replace = function(search, replacement) {
          var isRegex = self.isRegExp(search),
              origLastIndex,
              captureNames,
              result;
   ...
   * @returns {Array} Array of substrings.
   */
  (<any>fixed).split = function(separator, limit) {
